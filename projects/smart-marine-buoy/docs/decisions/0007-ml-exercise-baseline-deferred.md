...
- **Consequences:** Keeps the MVP tight and pre-empts the "why not a spectral estimator" question without forcing the work now. The v2 benchmark becomes a strong follow-up result either way it lands.
