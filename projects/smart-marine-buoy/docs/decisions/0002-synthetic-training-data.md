...
- **Consequences:** A reproducible, expandable dataset, and a documented synthetic-to-real domain gap treated as a first-class research question. Requires implementing the spectral synthesis — which ties directly into the signal-processing study.
